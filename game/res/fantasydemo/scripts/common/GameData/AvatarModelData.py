...
class ModelData:
	...
	def loadDyes( resPath ):
		dyes = {}
		if resPath != "" and _HAS_OPEN_SECTION:
...
def load():
	if not _HAS_OPEN_SECTION:
		print "AvatarModelData: ResMgr.openSection not available, skipping load"
		global INDEXED_MODELS, MODEL_INDEXES, INDEXED_SFX, SFX_INDEXES
		INDEXED_MODELS = {}
		MODEL_INDEXES = {}
		INDEXED_SFX = {}
		SFX_INDEXES = {}
